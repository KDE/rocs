...
void Tests::testCreatingSimpleGraph()
{
...
void Tests::testCreatingSimpleGraphNodes()
{
...
void Tests::testCreatingSimpleGraphEdges()
{
// Creating a K5, 50px distance of each node.
/*
      1 51 101 151 201
...
void Tests::testManipulatingSimpleGraphEdges()
{
...
void Tests::testRemovingSimpleGraphNodes()
{
  Graph *graph1 = _graphCollection[0];
  Graph *graph2 = _graphCollection[1];
...
void Tests::testRemovingSimpleGraphEdges()
{
...
void Tests::testDestructingSimpleGraph()
{
